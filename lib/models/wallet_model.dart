...
class ResultWalletForMemberModel {
  ...
  List<WalletForMemberModel>? data;
  String? message;
  bool? status;

  factory ResultWalletForMemberModel.fromJson(Map<String, dynamic> json) =>
      ResultWalletForMemberModel(
        data: List<WalletForMemberModel>.from(
            json["data"].map((x) => WalletForMemberModel.fromJson(x))),
        message: json["message"],
        status: json["status"],
      );
...
class WalletForMemberModel {
  WalletForMemberModel({
    this.userId,
    this.userName,
    this.userEmail,
    this.userPhone,
  ...
  factory WalletForMemberModel.fromJson(Map<String, dynamic> json) =>
      WalletForMemberModel(
        userId: json["user_id"],
        userName: json["user_name"],
        userEmail: json["user_email"],
